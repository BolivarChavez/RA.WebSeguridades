<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Usuarios.aspx.cs" Inherits="WebSeguridades.Views.Usuarios" %>
        ...
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Mantenimiento de Usuarios</p>
                </div>  
                        ...
                        <form id="form1" runat="server">
                            ...
                            <ContentTemplate>
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <button class="btn btn-outline-dark navbar-btn boton-buscar boton-margen" id="BtnBuscar" runat="server" onserverclick="BtnBuscar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Busca registros de usuarios"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-grabar boton-margen" id="BtnGrabar" runat="server" onserverclick="BtnGrabar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Graba registro de usuario"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-eliminar boton-margen" id="BtnEliminar" runat="server" onserverclick="BtnEliminar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Elimina registro de usuario"></button>
                                </nav>
                                <div id="DivOpciones" class="px-2" runat="server">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="Nombre" class="col-form-label col-form-label-sm" style="font-weight:bold;">Nombre Completo</label>
                                            <input type="text" class="form-control form-control-sm" id="Nombre" placeholder="" runat="server" maxlength="100"/>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="Login" class="col-form-label col-form-label-sm" style="font-weight:bold;">Nombre de Usuario</label>
                                            <input type="text" class="form-control form-control-sm" id="Login" placeholder="" runat="server" maxlength="100"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="Password" class="col-form-label col-form-label-sm" style="font-weight:bold;" id="lblPassword">Contraseña</label>
                                            <input type="text" class="form-control form-control-sm" id="Password" placeholder="" runat="server" maxlength="100"/>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="Email" class="col-form-label col-form-label-sm" style="font-weight:bold;">Correo Electronico</label>
                                            <input type="text" class="form-control form-control-sm" id="Email" placeholder="" runat="server" maxlength="100"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
