<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CambioPassword.aspx.cs" Inherits="WebSeguridades.Views.CambioPassword" %>
...
<head runat="server">
    ...
    <title>Actualizacion de contraseña de Usuario</title>
...
<body style="margin: 0; height: 100%; overflow: hidden; background-color: #E5E8E8;">
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Actualizacion de contraseña de Usuario</p>
                </div>  
                        ...
                        <form id="form1" runat="server">
                            ...
                            <ContentTemplate>
                                <nav class="navbar navbar-expand-lg">
                                    <button class="btn btn-outline-dark navbar-btn boton-grabar boton-margen" id="BtnGrabar" runat="server"  onserverclick="BtnGrabar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Graba nueva contraseña"></button>
                                </nav>
                                <div id="DivOpciones" class="px-2" runat="server">
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <asp:DropDownList ID="Usuario" CssClass="form-select form-select-sm" style="width: 100%" runat="server" AutoPostBack="True"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="Password1" class="col-form-label col-form-label-sm" style="font-weight:bold;">Nueva contraseña</label>
                                            <input type="password" class="form-control form-control-sm" id="Password1" placeholder="" required="" runat="server" maxlength="100"/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-4">
                                            <label for="Password2" class="col-form-label col-form-label-sm" style="font-weight:bold;">Confirmar contraseña</label>
                                            <input type="password" class="form-control form-control-sm" id="Password2" placeholder="" runat="server" maxlength="100"/>
                                        </div>
                                    </div>
                                </div>
                            </ContentTemplate>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Actualizacion de contraseña de Usuario</h5>
        ...
        <script src="../Scripts/CambioPassword.js" type="text/javascript"></script>
        <script>
