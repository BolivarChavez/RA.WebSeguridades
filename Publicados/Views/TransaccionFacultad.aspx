<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransaccionFacultad.aspx.cs" Inherits="WebSeguridades.Views.TransaccionFacultad" %>
...
<head runat="server">
    ...
    <title>Mantenimiento de Facultades asociadas a Transacciones</title>
...
<body style="margin: 0; height: 100%; overflow: hidden; background-color: #E5E8E8;">
        <div class="container-fluid">
            <div class="row header-bar-height" style="background-color: #E5E8E8;">
                ...
                <div class="col-sm-12 col-md-8 col-lg-8 col-xl-8 center-block text-left my-auto">
                    <p class="barra-titulo" style="color:#2C3E50;">Mantenimiento de Facultades asociadas a Transacciones</p>
                </div>  
                        ...
                        <form id="form1" runat="server">
                            ...
                            <ContentTemplate>
                                <nav class="navbar navbar-expand-lg">
                                    ...
                                    <button class="btn btn-outline-dark navbar-btn boton-buscar boton-margen" id="BtnBuscar" runat="server" onserverclick="BtnBuscar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Busca registros de facultades asociadas a transacción"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-grabar boton-margen" id="BtnGrabar" runat="server" onserverclick="BtnGrabar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Graba registro de facultad asociada a la transacción"></button>
                                    <button class="btn btn-outline-dark navbar-btn boton-eliminar boton-margen" id="BtnEliminar" runat="server" onserverclick="BtnEliminar_ServerClick" data-toggle="tooltip" data-placement="bottom" title="Elimina registro de facultad asociada a la transacción"></button>
                                </nav>
                                <div id="DivOpciones" class="px-2" runat="server">
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <asp:DropDownList ID="Transaccion" CssClass="form-select form-select-sm" style="width: 50%" runat="server" AutoPostBack="True"></asp:DropDownList>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="Facultad" class="col-form-label col-form-label-sm" style="font-weight:bold;">Facultad</label>
                                            <asp:DropDownList ID="Facultad" CssClass="form-select form-select-sm" style="width: 50%" runat="server" AutoPostBack="True"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-6">
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Mantenimiento de Facultades asociadas a Transacciones</h5>
        ...
        <script src="../Scripts/TransaccionFacultad.js" type="text/javascript"></script>
        <script>
